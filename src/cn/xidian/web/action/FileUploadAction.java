...
public class FileUploadAction extends ActionSupport implements RequestAware, SessionAware {
	...
	public void setStudentPerformanceHandleService(StudentPerformanceHandleService studentPerformanceHandleService) {
	...
	public String uploadFile() {
		...
		try {
			...
			studentPerformanceHandleService.handleExcel(realPath + "/excel/" + filename,isreplace);
